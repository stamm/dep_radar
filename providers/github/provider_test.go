...
func TestGithubRepo_GetUrl(t *testing.T) {
	...
	url := prov.makeURL(dep_radar.Pkg("github.com/Masterminds/glide"), "master", "glide.lock")
...
func TestGithubRepo_GetUrlWithBranch(t *testing.T) {
	...
	prov := New(&mocks.IWebClient{})
	url := prov.makeURL(dep_radar.Pkg("github.com/Masterminds/glide"), "dev", "glide.lock")
...
func TestGithubRepo_GetUrlSubpackage(t *testing.T) {
	...
	url := app.makeURL(dep_radar.Pkg("github.com/stretchr/testify/require"), "master", "doc.go")
...
func TestGithubRepo_WithDep(t *testing.T) {
	...
	pkg := dep_radar.Pkg("github.com/Masterminds/glide")
...
func TestGithubTags_Ok(t *testing.T) {
  ...
  },
  {
	...
	pkg := dep_radar.Pkg("github.com/golang/dep")
