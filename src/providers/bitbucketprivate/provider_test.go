...
func TestBBRepo_SetProjectWithError(t *testing.T) {
	...
	mHttpClient := &mocks.IWebClient{}
	mHttpClient.On("Get", mock.Anything, "https://godep.example.com/app?go-get=1").Return([]byte(``), errors.New("err"))
...
func TestBBRepo_WithDep(t *testing.T) {
	...
	mHttpClient := &mocks.IWebClient{}
	mHttpClient.On("Get", mock.Anything, "https://bitbucket.example.com/projects/go/repos/app/raw/glide.lock?at=refs%2Fheads%2Fmaster").Return([]byte(`imports:
- name: pkg1
  version: hash1`), nil)
...
func TestBBTags_Ok(t *testing.T) {
	...
	mHttpClient := &mocks.IWebClient{}
	mHttpClient.On("Get", mock.Anything, "https://bitbucket.example.com/rest/api/1.0/projects/go/repos/app/tags?start=0").Return([]byte(`
...
func TestBBTags_TwoPages(t *testing.T) {
 ...
 {"id":"refs/tags/v0.1.0","displayId":"10.4.0","type":"TAG","latestCommit":"5d6de801e6bb31eb1086adf3604570693580f141","latestChangeset":"5d6de801e6bb31eb1086adf3604570693580f141","hash":null}
	...
	mHttpClient.On("Get", mock.Anything, "https://bitbucket.example.com/rest/api/1.0/projects/go/repos/app/tags?start=1").Return([]byte(`
...
func TestGithubTags_Error(t *testing.T) {
	...
	mHttpClient := &mocks.IWebClient{}
	mHttpClient.On("Get", mock.Anything, "https://bitbucket.example.com/rest/api/1.0/projects/go/repos/app/tags?start=0").Return(nil, errors.New("error"))
...
func TestBBTags_BadFile(t *testing.T) {
	...
	mHttpClient := &mocks.IWebClient{}
	mHttpClient.On("Get", mock.Anything, "https://bitbucket.example.com/rest/api/1.0/projects/go/repos/app/tags?start=0").Return([]byte(`{`), nil)
